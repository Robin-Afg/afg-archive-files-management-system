...
<div class="card-body">
    ...
    <div class="table-responsive">
                                ...
                                <tr>
                                        <td>
                                            <div class="btn-group ml-auto" style="direction:rtl;">
                                                    <a href="{{url('panel_warada/view',['file' => $file->id])}}"  title="نمایش سند" class="btn btn-sm btn-outline-light text-dark"> <i class="far fas fa-eye"></i></a>
                                                    @if(!(Auth::user()->type === 3))   
                                                        ...
                                                        <a href="{{url('panel_warada/access',['file' => $file->id])}}" title="دسترسی دادن کاربران" class="btn btn-sm btn-outline-light text-dark" > <i class="far fas fa-user"></i> </a>
                                                        <a href="{{url('panel_warada/update',['file' => $file->id])}}" title="ویرایش سند" class="btn btn-sm btn-outline-light text-dark" > <i class="far fas fa-edit"></i></a>
                                                    @endif
      ...
      <span id="base_url" hidden>{{asset('/')}}</span>
        ...
        <div class="modal fade" id="warada_users" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
$(document).ready(function () {
    ...
    $(".delete").click(function(){
        ...
        .then((willDelete) => {
          if (willDelete) {
            $.get(base_url+"panel_warada/delete/"+id, function(data){
