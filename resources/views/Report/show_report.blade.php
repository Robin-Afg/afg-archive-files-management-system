...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">       
      <div class="card">
          <h1 class="card-header text-center"><b> نمایش  گزارش تخنیکی    </b>
             @if(Auth::user()->type == 1 || Auth::user()->type == 2)
              <div class="btn-group dropright float-left">
                  ...
                  <div class="dropdown-menu text-right">
                    <!-- Dropdown menu links -->
                    <a class="dropdown-item" href="{{url('panel_report/update',['file' => $file->id])}}">  ویرایش</a>
                    <a class="dropdown-item" href="{{route('panel_report/access',['file' => $file->id])}}">  دسترسی دادن </a>
            ...
            <div class="card-body">
              <div class="row ">
                ...
                <div class="col">
                    ...
                    <input id="ca2" type="text" tabindex=5 class="form-control text-right" name="year" value="{{Helper::gr_to_hejri_style2($file->year)}}" readonly>           
                </div>

                <div class="col ">
                    <label for="inputText3" class=" col-form-label">  شماره تفصیلی گزارش     </label>
                    <input id="inputText3" tabindex=4 type="text" class="form-control text-right" name="report_num" value="{{$file->report_num}}" readonly>
                </div>
                
                <div class="col">
                   <label for="inputText3" class="col-form-label">  اسم مولف  </label>
                   <input  type="text" tabindex=3 class="form-control text-right" name="author" value="{{$file->author}}" readonly>         
                </div>
              ...
              <div class="row ">
               ...
               <div class="col">
                   <label for="inputText3" class="col-form-label">   تاریخ ثبت     </label>
                    <input id="ca3" type="text" tabindex=2 class="form-control text-right" name="date_of_archiving" value="{{Helper::gr_to_hejri_style2($file->date_of_archiving)}}" readonly>  
     ...
     <div class="card-body">
       <div class="row ">
           ...
           <div class="col">
               ...
               <input id="inputText3" type="text" tabindex=9 class="form-control text-right" name="revised_num" value="{{$file->revised_num}}" readonly>          
                 
           </div>

           <div class="col">
               <label for="inputText3" class="col-form-label"> محل نگهداری  </label>
               <input id="inputText3" type="text" tabindex=8 class="form-control text-right" name="place" value="{{$file->place}}" readonly>          
           </div>
...
<!---------------------------other section -------------------------->
 ...
 <!------------------------------------------------------ access section of user ---------------------------->  
                      ...
                      <div class="col mt-4 mb-5">
                        ...
                        <form action="{{url('/show_report/'.$file->uuid.'/Download')}}" method="post">
                                {{csrf_field()}}
         ...
         @foreach($file->comments->sortByDesc('id') as $comment)  
            <div class="review-block border-bottom mt-3 pt-3 text-right" >
                  ...
                  <div dir="ltr">
                     ...
                     <small class="text-mute" style="opacity:0.5;"> &nbsp;&nbsp; {{$comment->updated_at->diffForHumans()}}   <span dir="rtl"> بروز شده :  </span> </small>    
                  </div>
                  ...
                  <div class="float-left">
                      ...
                      @if(Auth::user()->id === 1 || $comment->user_id === Auth::user()->id) <!-- shows delete button for admin and the user who posted the comment -->
                          <form method="post" style="display:inline;" action="{{route('panel_report.view.delete_comment', $comment->id)}}">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                  <form method="post" action="{{route('edit_comment_report')}}">
...
<!--  ********************************* section post comment ******************************** -->
  <center>
   <div class="col-10 mb-3">
     <form method="POST" action="{{route('report_comment')}}">
        {{csrf_field()}}
            ...
            <div class="row">
                ...
                <div class="col-4" >         
                    <button type="submit" class="btn btn-primary text-center">افزوذن نظر </button>
                    <input type="hidden" value="{{$file->id}}" name="report_id">
                </div>
            </div>     
