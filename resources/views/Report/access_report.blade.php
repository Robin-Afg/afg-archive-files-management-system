...
<div class="col-xl-12 col-lg-6 col-md-12 col-sm-12 col-12">
    <div class="card">
      <div class="card-header">
        ...
        <h3 class=" text-center">    مدیریت دسترسی برای گزارش تخنیکی   نمبر  : {{$file->crida_number}}  
                      ...
                      <tr>
                          ...
                          <td>
                              <div class="btn-group ml-auto">
                                  ...
                                  <a href="{{url('panel/report')}}/revoke/{{$row->id}}/{{$row->user->id}}">
  ...
  <div class="col-12 pt-3">
    <form method="POST" action="{{route('grant_report')}}">
