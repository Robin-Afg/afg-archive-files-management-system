...
<div class="card-body">
    ...
    <div class="table-responsive">
              ...
              <table id="dtBasicExample" class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">  مولف </th>
                                <th scope="col">  تاریخ ثبت گزارش    </th>
                                ...
                                <tr>
                                    <td>
                                        <div class="btn-group ml-auto" style="direction:rtl;">
                                            <a href="{{url('panel_report/view',['file' => $file->id])}}" title="نمایش سند"  class="btn btn-sm btn-outline-light text-dark"> <i class="far fas fa-eye"></i></a>  
                                            @if(!(Auth::user()->type === 3))   
                                            ...
                                            <a href="{{url('panel_report/access',['file' => $file->id])}}" title="دسترسی دادن کاربران" class="btn btn-sm btn-outline-light text-dark" > <i class="far fas fa-user"></i> </a>
                                            <a href="{{url('panel_report/update',['file' => $file->id])}}" title="ویرایش سند" class="btn btn-sm btn-outline-light text-dark" > <i class="far fas fa-edit"></i></a>
                                            @endif
                                            @if(Auth::user()->type === 1)
                                    ...
                                    <td class="td-control">{{$file->author}}</td>
      ...
      <span id="base_url" hidden>{{asset('/')}}</span>
        ...
        <div class="modal fade" id="report_users" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
$(document).ready(function () {
    ...
    $(".delete").click(function(){
        ...
        .then((willDelete) => {
          if (willDelete) {
            $.get(base_url+"panel_report/delete/"+id, function(data){
