...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">       
      <div class="card">
          <h1 class="card-header text-center"><b>  نمایش فایل مربوطه احکام ، فرامین ، و مصوبات کابینه دارالنشا و شورای وزیران     </b>
                ...
                <div class="btn-group dropright float-left">
                    ...
                    <div class="dropdown-menu text-right">
                      <!-- Dropdown menu links -->
                      <a class="dropdown-item" href="{{url('panel_ahkam/update',['file' => $file->id])}}">  ویرایش</a>
                      <a class="dropdown-item" href="{{route('panel_ahkam/access',['file' => $file->id])}}">  دسترسی دادن </a>
            ...
            <div class="card-body">
              <div class="row ">
                ...
                <div class="col">
                    ...
                    <input id="ca1" type="text" tabindex=4 class="form-control text-right" name="date_of_document" value="{{Helper::gr_to_hejri($file->date_of_document)}}" readonly>     
                </div>


                  <div class="col ">
                    <label for="inputText3" class=" col-form-label">  شماره این سند     </label>
                    <input id="inputText3" tabindex=5 type="text" class="form-control text-right" name="number_of_document" value="{{$file->number_of_document}}" readonly>
                  </div>
                ...
                <div class="col">
                  <label for="inputText3" class="col-form-label"> نوعیت سند  </label>
                    <input  type="text" tabindex=3 class="form-control text-right" name="type_of_document" value="{{$file->type_of_document}}" readonly>     
                </div>
              ...
              <div class="card-header"><h3>   ملاحظات     </h3></div>
                <div class="card-body">
                  <div class="row">
                      ...
                      <div class="col">
                          <textarea id="inputText3" type="text" tabindex=6 class="form-control text-right" name="molahezat" readonly > {{$file->molahezat}} </textarea>        
                      </div>
...
<!--------------------------- file  section -------------------------->
                  ...
                  <div class="card-body">
                    <div class="row ">
                        <div style="margin-top: 0px; padding-left:8px;"> 
                            ...
                            <textarea  cols="30" rows=" 3" class="form-control text-right"   name="more" readonly> {{$file->more}}  </textarea>
                         </div>
 ...
 <!------------------------------------------------------ access section of user ---------------------------->  
                      ...
                      <div class="col mt-4 mb-5">
                        ...
                        <form action="{{url('/show_ahkam/'.$file->uuid.'/Download')}}" method="post">
                                {{csrf_field()}}
                  ...
                  <div dir="ltr">
                    ...
                    <div class="float-left">
                        ...
                        @if(Auth::user()->id === 1 || $comment->user_id === Auth::user()->id) <!-- shows delete button for admin and the user who posted the comment -->
                            <form method="post" style="display:inline;" action="{{route('panel_ahkam.view.delete_comment', $comment->id)}}">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                  <form method="post" action="{{route('edit_comment_ahkam')}}">
...
<!--  ********************************* section post comment ******************************** -->
  <center>
   <div class="col-10 mb-3">
     <form method="POST" action="{{route('ahkam_comment')}}">
        {{csrf_field()}}

            <div class="row">
                <div class="col-8">
                  <textarea id="editor" name="comment" class="editor form-control text-right  @if ($errors->has('comment'))  <?php if(isset($er)){ echo $er;} ?> @endif"   placeholder="نظر خویش را بنویسید  "  ></textarea>
                ...
                <div class="col-4" >
                    <input type="hidden" value="{{$file->id}}" name="ahkam_id" >        
