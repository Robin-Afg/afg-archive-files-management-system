...
<div class="col-xl-12 col-lg-6 col-md-12 col-sm-12 col-12">
    <div class="card">
      ...
      <div class="card-header">
        <h3 class=" text-center">    مدیریت دسترسی برای فایل  نمبر  : {{$file->crida_number}}  
              <div>   تاریخ مکتوب   : {{Helper::gr_to_hejri_style2($file->date_of_archiving)}} </div> 
        </h3>
      </div>
                      ...
                      <tr>
                          ...
                          <td>
                              <div class="btn-group ml-auto">
                                  ...
                                  <a href="{{url('panel/ahkam')}}/revoke/{{$row->id}}/{{$row->user->id}}">
  ...
  <div class="col-12 pt-3">
      <form method="POST" action="{{route('grant_ahkam')}}">
