    ...
    <h1 class="card-header text-center">
            ...
            <div class="btn-group dropright float-left">
              ...
              <div class="dropdown-menu text-right">
                <!-- Dropdown menu links -->
                <a class="dropdown-item" href="{{url('panel_sadera/update',['file' => $files->id])}}">  ویرایش</a>
                <a class="dropdown-item" href="{{route('panel_sadera/access',['file' => $files->id])}}">  دسترسی دادن </a>
                  ...
                  <div class="card-body">
                    <div class="row ">
                        ...
                        <div class="col  ">
                              ...
                              <input id="inputText3" dir="rtl" type="text" class="form-control text-right" value="{{$files->copyto}}" readonly>
                        </div>
                        
                        <div class="col  ">
                              <label for="inputText3" class=" col-form-label">  مرسل الیه     </label>
                              <input id="inputText3" dir="rtl" type="text" class="form-control text-right" value="{{$files->mursal_alia}}" readonly>
                        </div>

                      <div class="col">
                       <label for="inputText3" class="col-form-label"> 
                        مرسل     </label>
                        <input id="inputText3" dir="rtl" type="text" class="form-control text-right" value="{{$files->mursal}}" readonly>          
                        </div>
                  ...
                  <div class="card-body">
                    <div class="row ">
                      <div class="col-md-8">
                        ...
                        <input id="inputText3" type="text" class="form-control text-right" value="{{Helper::gr_to_hejri_style2($files->dateofmaktoob)}}" readonly>
                      </div>
                      
                      <div class="col-md-4">
                       <label for="inputText3" class="col-form-label"> 
                        شماره مسلسل     </label>
                        <input id="inputText3" type="number" class="form-control text-right" value="{{Helper::extract_number($files->crida_number)}}" readonly>          
                        </div>
                    ...
                    <div class="row ">
                         <div class="col">
                           <label for="exampleFormControlTextarea1">  خلص مطلب </label>
                            <textarea class="form-control text-right" id="exampleFormControlTextarea1" rows="3"  readonly>{{$files->kholasmatlab}}</textarea> 
                           </div>
                  ...
                  <div class="card-body">
                    <div class="row">
                       <div class="col">
                             <label for="inputText3" class="col-form-label"> 
                              محل      </label>
                              <input id="inputText3" type="text" class="form-control text-right" value="{{$files->place}}" readonly>          
                          </div>

                           <div class="col">
                           <label for="inputText3" class="col-form-label"> 
                            تاریخ       </label>
                          <input id="inputText3" type="text" class="form-control text-right" value="{{Helper::gr_to_hejri_style2($files->date_of_archiving)}}" readonly>          
                        </div>
                        
                        <div class="col">
                           <label for="inputText3" class="col-form-label"> 
                             الماری      </label>
                            <input id="inputText3" type="text" class="form-control text-right" value="{{$files->almary}}" readonly>          
                        </div>

                        <div class="col">
                           <label for="inputText3" class="col-form-label"> 
                             نمبر دوسیه / کارتن    </label>
                            <input id="inputText3" type="text" class="form-control text-right" value="{{$files->num_of_dosia}}" readonly>          
                        </div>
                  ...
                  <div class="card-body">
                    <div class="row ">
                         ...
                         <div class="col">
                           <label for="inputText3" class="col-form-label"> 
                            ضمیمه     </label>
                            <input id="inputText3" type="text" class="form-control text-right" value="{{$files->zamema}}" readonly>          
                        </div>
                      
                        <div class="col">
                           <label for="inputText3" class="col-form-label"> 
                             کاپی      </label>
                            <input id="inputText3" type="text" class="form-control text-right" value="{{$files->copy}}" readonly>          
                        </div>

                        <div class="col">
                           <label for="inputText3" class="col-form-label"> 
                              اصلی     </label>
                            <input id="inputText3" type="text" class="form-control text-right" value="{{$files->asal}}" readonly>          
                        </div>
...
<!---------------------------other section -------------------------->
 ...
 <!------------------------------------------------------ access section of user ---------------------------->  
                          ...
                          <!-- ِSecurely downloading file related file with form -->
                              <form action="{{url('/show_sadera/'.$files->uuid.'/Download')}}" method="post">
                                     {{csrf_field()}}
                    ...
                    <div class="row ">
                         <div class="col">
                           <label for="exampleFormControlTextarea1"> مراجعه و اقدام  </label>
                            <textarea class="form-control text-right" id="exampleFormControlTextarea1" rows="3"  readonly>{{$files->action}}</textarea> 
                           </div>           
                  </div>
               </div>
            </div>
     ...
     <div style="overflow-y: scroll; max-height:400px;" class="col-12">    
      @foreach($files->comments->sortByDesc('id') as $comment)  
        <div class="review-block border-bottom mt-3 pt-3 text-right" >
                  ...
                  <div dir="ltr">
                   ...
                   <div class="float-left">
                      ...
                      @if(Auth::user()->id === 1 || $comment->user_id === Auth::user()->id) <!-- shows delete button for admin and the user who posted the comment -->
                          <form method="post" style="display:inline;" action="{{route('panel_sadera.view.delete_comment', $comment->id)}}">
                  ...
                  <?php  if(Auth::user()->id == $comment->user_id){ $font = "color:#000;"; } else { $font = " ";} ?>
                  <p style="margin-right:20%; <?php echo $font; ?>" class="review-text font-italic m-0 mt-3">  {!!$comment->comment!!}  </p>
             ...
             <div class="modal-dialog" role="document">
                  <div class="modal-content">
                      ...
                      <div class="modal-body">
                            <form method="post" action="{{route('edit_comment_sadera')}}">
...
<!--  ********************************* section post comment ******************************** -->
  <center>
   <div class="col-10 mb-3">
     <form method="POST" action="{{route('sadera_comment')}}">

        {{csrf_field()}}
                                          
          <div class="row">
              <div class="col-8">
                <textarea id="editor" name="comment" class="form-control text-right align-right  @if ($errors->has('comment'))  <?php if(isset($er)){ echo $er;} ?> @endif "  rows="4" cols="50"  placeholder="نظر خویش را بنویسید  "></textarea>
              ...
              <div class="col-4" >         
                  <button type="submit" class="btn btn-primary text-center">افزوذن نظر </button><input type="hidden" value="{{$files->id}}" name="sadera_id" >
              </div>
          </div>                   
