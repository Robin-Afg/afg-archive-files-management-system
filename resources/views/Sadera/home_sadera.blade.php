                                  ...
                                  <tr>
                                      <td>
                                        <div class="btn-group ml-auto">
                                          <a href="{{route('panel_sadera/view',['file' => $file->id])}}"   class="btn btn-sm btn-outline-light text-dark"> <i class="far fas fa-eye"></i></a>
                                        </div>
                                      </td>
                                      <td class="td-control" >{{$file->mursal_alia}}</td>
                                      <td class="td-control" >{{$file->mursal}}</td>
                                      <td class="td-control" style="direction:ltr;" >{{Helper::gr_to_hejri_style2($file->dateofmaktoob)}}</td>
