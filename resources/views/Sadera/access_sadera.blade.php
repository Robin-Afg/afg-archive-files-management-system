...
<div class="col-xl-12 col-lg-6 col-md-12 col-sm-12 col-12">
    <div class="card">
      <div class="card-header">
        <h3 class=" text-center">
              ...
              مدیریت دسترسی برای مکتوب صادره  نمبر  : {{$file->crida_number}}  

        <div>   تاریخ مکتوب   : {{$file->dateofmaktoob}} </div> </h3>
      </div>
        <div class="card-body">
          <div class="row">
                      ...
                      <tr>
                          ...
                          <td>
                              <div class="btn-group ml-auto">
                                  ...
                                  <a href="{{url('panel/sadera')}}/revoke/{{$row->id}}/{{$row->user->id}}">
  ...
  <div class="col-12 pt-3">
    <form method="POST" action="{{route('grant_sadera')}}">
        ...
        <input type="hidden" value="{{$file->id}}" name="sadera_id" />
