...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">       
      <div class="card">
          <h1 class="card-header text-center"><b> نمایش مکتوب استعلام    </b>
             @if(Auth::user()->type == 1 || Auth::user()->type == 2)
              <div class="btn-group dropright float-left">
                  ...
                  <div class="dropdown-menu text-right">
                    <!-- Dropdown menu links -->
                    <a class="dropdown-item" href="{{url('panel_estelam/update',['file' => $file->id])}}">  ویرایش</a>
                    <a class="dropdown-item" href="{{route('panel_estelam/access',['file' => $file->id])}}">  دسترسی دادن </a>
            ...
            <div class="card-body">
              <div class="row ">
                ...
                <div class="col ">
                    ...
                    <input id="inputText3" tabindex=5 type="text" class="form-control text-right" name="add_of_sender" value="{{$file->add_of_sender}}" readonly>   
                  </div>
                  
                <div class="col">
                   <label for="inputText3" class="col-form-label">  تاریخ صدور    </label>
                   <input  type="text" tabindex=4 class="form-control text-right" name="date_of_sodor" value="{{Helper::gr_to_hejri($file->date_of_sodor)}}" readonly>        
                </div>


                <div class="col">
                  <label for="inputText3" class="col-form-label"> تاریخ استعلام  </label>
                  <input  type="text" tabindex=3 class="form-control text-right" name="date_of_estelam" value="{{Helper::gr_to_hejri($file->date_of_estelam)}}" readonly>       
                </div>
              ...
              <div class="row ">
               ...
               <div class="col-md-8">
                   <label for="inputText3" class="col-form-label">   تاریخ ثبت     </label>
                    <input id="ca3" type="text" tabindex=2 class="form-control text-right" name="date_of_archiving" value="{{Helper::gr_to_hejri($file->date_of_archiving)}}" readonly>               
               </div>
     ...
     <div class="card-body">
       <div class="row ">
           ...
           <div class="col">
               ...
               <input id="inputText3" type="text" tabindex=9 class="form-control text-right" name="marja" value="{{$file->marja}}" readonly>          
           </div>

           <div class="col">
               <label for="inputText3" class="col-form-label"> ریاست  </label>
               <input id="inputText3" type="text" tabindex=8 class="form-control text-right" name="reyasat" value="{{$file->reyasat}}" readonly>          
           </div>

           <div class="col">
               <label for="inputText3" class="col-form-label"> وزارت  </label>
               <input id="inputText3" type="text" tabindex=7 class="form-control text-right" name="wozarat" value="{{$file->wozarat}}" readonly>          
           </div>
            ...
            <div class="card-body">
              <div class="row">
                  ...
                  <div class="col">
                      ...
                      <input id="inputText3" type="text" tabindex=12 class="form-control text-right" name="zamema" value="{{$file->zamema}}" readonly >          
                  </div>
                  ...
                  <div class="col">
                      ...
                      <input id="inputText3" type="text" tabindex=11 class="form-control text-right" name="asal" value="{{$file->asal}}" readonly>          
                  </div>
...
<!--------------------------- file  section -------------------------->
 ...
 <!------------------------------------------------------ access section of user ---------------------------->  
                      ...
                      <div class="col mt-4 mb-5">
                        ...
                        <form action="{{url('/show_estelam/'.$file->uuid.'/Download')}}" method="post">
                                {{csrf_field()}}
            ...
            <div class="review-block border-bottom mt-3 pt-3 text-right" >
                  ...
                  <div class="float-left">
                      ...
                      @if(Auth::user()->id === 1 || $comment->user_id === Auth::user()->id) <!-- shows delete button for admin and the user who posted the comment -->
                          <form method="post" style="display:inline;" action="{{route('panel_estelam.view.delete_comment', $comment->id)}}">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                  <form method="post" action="{{route('edit_comment_estelam')}}">
...
<!--  ********************************* section post comment ******************************** -->
  <center>
   <div class="col-10 mb-3">
     <form method="POST" action="{{route('estelam_comment')}}">
        {{csrf_field()}}
            ...
            <div class="row">
                ...
                <div class="col-4" >         
                    <button type="submit" class="btn btn-primary text-center">افزوذن نظر </button><input type="hidden" value="{{$file->id}}" name="estelam_id" >
                </div>
            </div>     
