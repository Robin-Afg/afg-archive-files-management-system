...
<!-- Basic form -->
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card"><h1 class="card-header text-center"> <b> اضافه نمودن مکتوب استعلام    </b></h1>
                 @include('layouts.msg')      
            <div class="card-body">     
                         
    <form method="POST" action="{{route('save_estelam')}}" enctype="multipart/form-data" id="form_estelam">
        {{csrf_field()}}
                  ...
                  <div class="card-body">
                    <div class="row ">
                      ...
                      <div class="col ">
                          ...
                          <input id="inputText3" tabindex=5 type="text" class="form-control text-right  @if ($errors->has('add_of_sender'))  <?php if(isset($er)){ echo $er;} ?> @endif " name="add_of_sender" value="{{old('add_of_sender')}}">
                      ...
                      <div class="col">
                        <label for="inputText3" class="col-form-label"> تاریخ استعلام  </label>
                          <input id="ca2" onKeyDown="return false" type="text" tabindex=3 class="form-control text-right
                            @if ($errors->has('date_of_estelam'))  <?php if(isset($er)){ echo $er;} ?> @endif " name="date_of_estelam" value="{{old('date_of_estelam')}}">  
           ...
           <div class="card-body">
             <div class="row ">
                 ...
                 <div class="col">
                     ...
                     <input id="inputText3" type="text" tabindex=9 class="form-control text-right @if ($errors->has('marja'))  <?php if(isset($er)){ echo $er;} ?> @endif" name="marja" value="{{old('marja')}}" >          
                        @if ($errors->has('marja'))
                            <span class="help-block">
                 ...
                 <div class="col">
                     ...
                     <input id="inputText3" type="text" tabindex=8 class="form-control text-right @if ($errors->has('reyasat'))  <?php if(isset($er)){ echo $er;} ?> @endif" name="reyasat" value="{{old('reyasat')}}" >          
                 ...
                 <div class="col">
                     ...
                     <input id="inputText3" type="text" tabindex=7 class="form-control text-right @if ($errors->has('wozarat'))  <?php if(isset($er)){ echo $er;} ?> @endif" name="wozarat" value="{{old('wozarat')}}" >          
                  ...
                  <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input id="inputText3" type="text" tabindex=12 class="form-control text-right  @if ($errors->has('zamema'))  <?php if(isset($er)){ echo $er;} ?> @endif " name="zamema" value="{{old('zamema')}}" >          
                        ...
                        <div class="col">
                            ...
                            <input id="inputText3" type="text" tabindex=11 class="form-control text-right  @if ($errors->has('asal'))  <?php if(isset($er)){ echo $er;} ?> @endif " name="asal" value="{{old('asal')}}" >          
                              @if ($errors->has('asal'))
                                <span class="help-block">
...
<!---------------------------other section -------------------------->
              ...
              <div class="form-group text-center mb-3 mt-3">
                  ...
                  <a href="#" class="btn btn-rounded btn-primary" onclick="document.getElementById('s_new').name = 'save_and_new'; document.getElementById('form_estelam').submit();" name="save_and_new">    ذخیره   و صفحه جدید </a> 
              </div>
