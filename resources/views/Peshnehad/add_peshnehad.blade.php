...
<div class="card-body">
    ...
    <form method="POST" action="{{route('save_peshnehad')}}" enctype="multipart/form-data" id="form_peshnehad">
        {{csrf_field()}}
                  ...
                  <div class="card-body">
                    <div class="row ">
                      ...
                      <div class="col ">
                              ...
                              <input id="inputText3" tabindex=4 type="text" class="form-control text-right  @if ($errors->has('add_of_peshnehader'))  <?php if(isset($er)){ echo $er;} ?> @endif " name="add_of_peshnehader" value="{{old('add_of_peshnehader')}}">
                        ...
                        <div class="col">
                         <label for="inputText3" class="col-form-label">  تاریخ پیشنهاد       </label>                                                      
                             <input id="ca1" onKeyDown="return false" type="text" tabindex=3 class="form-control text-right
                                @if ($errors->has('date_of_peshnehad'))  <?php if(isset($er)){ echo $er;} ?> @endif " name="date_of_peshnehad" value="{{old('date_of_peshnehad')}}">  
                        ...
                        <div class="col">
                           <label for="inputText3" class="col-form-label">  شماره مسلسل     </label>
                              <input id="inputText3" tabindex=1 type="number" class="form-control text-right @if ($errors->has('crida_number'))  <?php if(isset($er)){ echo $er;} ?> @endif "  name="crida_number" value="{{ $last_id  }}">          
                  ...
                  <div class="card-body">
                    ...
                    <div class="col">
                           <label for="exampleFormControlTextarea1"> ارسال به شعبه مربوطه </label>
                            <textarea tabindex=6 class="form-control text-right @if ($errors->has('to'))  <?php if(isset($er)){ echo $er;} ?> @endif " id="exampleFormControlTextarea1" rows="3" name="to">{{old('to')}}</textarea> 
                            @if ($errors->has('to'))
                                  <span class="help-block">
                    ...
                    <div class="row ">
                         <div class="col">
                           <label for="exampleFormControlTextarea1">  خلص مطلب </label>
                            <textarea tabindex=5 class="form-control text-right @if ($errors->has('kholasmatlab'))  <?php if(isset($er)){ echo $er;} ?> @endif " id="exampleFormControlTextarea1" rows="3" name="kholasmatlab">{{old('kholasmatlab')}}</textarea> 
             ...
             <div class="row ">
                  ...
                  <div class="col">
                    <label for="inputText3" class="col-form-label">  تسلیمی     </label>
                       <input id="inputText3" tabindex=10 type="text" class="form-control text-right @if ($errors->has('taslemi'))  <?php if(isset($er)){ echo $er;} ?> @endif" name="taslemi" value="{{old('taslemi')}}">          
                  ...
                  <div class="col">
                    <label for="inputText3" class="col-form-label">  ضمیمه     </label>
                      <input id="inputText3" tabindex=9 type="text" class="form-control text-right @if ($errors->has('zamema'))  <?php if(isset($er)){ echo $er;} ?> @endif" name="zamema" value="{{old('zamema')}}" >          
                 ...
                 <div class="col">
                    <label for="inputText3" class="col-form-label">  کاپی      </label>
                       <input id="inputText3" tabindex=8 type="text" class="form-control text-right @if ($errors->has('copy'))  <?php if(isset($er)){ echo $er;} ?> @endif" name="copy" value="{{old('copy')}}">          
                         @if ($errors->has('copy'))
                           <span class="help-block">
                 ...
                 <div class="col">
                    <label for="inputText3" class="col-form-label">  اصل     </label>
                     <input id="inputText3" tabindex=7 type="text" class="form-control text-right @if ($errors->has('asal'))  <?php if(isset($er)){ echo $er;} ?> @endif" name="asal" value="{{old('asal')}}">          
                        @if ($errors->has('asal'))
                              <span class="help-block">
                    ...
                    <div class="row ">
                          ...
                          <div class="col  custom-file " style="margin-top: 60px; margin-left: 0px;">
                              ...
                              <div style="margin-top: -60px; padding:10px;"> 
                                  <input type="text" tabindex=11 class="form-control text-right"  name="more" placeholder="یاداشت اضافی">
                              </div>

                              <div>
                                  <input type="file" tabindex=12 id="customFile" name="file"  class="form-control  text-right @if ($errors->has('file'))  <?php if(isset($er)){ echo $er;} ?> @endif" dir="rtl">
                              </div>
                                @if ($errors->has('file'))
                                  <span class="help-block">
...
<!---------------------------other section -------------------------->
          ...
          <div class="form-group text-center mb-3 mt-3">
              ...
              <a href="#" class="btn btn-rounded btn-primary" onclick="document.getElementById('s_new').name = 'save_and_new'; document.getElementById('form_peshnehad').submit();" name="save_and_new">    ذخیره   و صفحه جدید </a>  
          </div>
