                                ...
                                <tr>
                                    <td>
                                        <div class="btn-group ml-auto" style="direction:rtl;">
                                            <a href="{{url('panel_peshnehad/view',['file' => $file->id])}}"  title="نمایش سند" class="btn btn-sm btn-outline-light text-dark"> <i class="far fas fa-eye"></i></a>       
                                            @if(!(Auth::user()->type === 3))    
                                            ...
                                            <a href="{{url('panel_peshnehad/access',['file' => $file->id])}}" title="دسترسی دادن کاربران" class="btn btn-sm btn-outline-light text-dark" > <i class="far fas fa-user"></i> </a>
                                            <a href="{{url('panel_peshnehad/update',['file' => $file->id])}}" title="ویرایش سند" class="btn btn-sm btn-outline-light text-dark" > <i class="far fas fa-edit"></i></a>
                                            @endif
...
$(document).ready(function () {
    ...
    $(".delete").click(function(){
        ...
        .then((willDelete) => {
          if (willDelete) {
            $.get(base_url+"panel_peshnehad/delete/"+id, function(data){
