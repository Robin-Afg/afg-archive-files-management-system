...
class CreateDeletedTReportTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('deleted_treports', function (Blueprint $table) {
            $table->increments('id');
            $table->string('crida_number');
            $table->integer('databse_id')->nullable();
    ...
    {
        Schema::dropIfExists('deleted_treports');
    }
}
